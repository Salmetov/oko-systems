...
# Server-rendered pages, page frame, and URL helpers extracted to oko_render.py.
from oko_render import (
    lang_query_href,
    add_lang_to_href,
    add_query_to_href,
    status_label,
    ...
    render_connect_bitrix_page,
    render_oauth_success_page,
)
...
# Static HTML fragments (base styles, confirm modal, frame script) live in oko_render.py.
from oko_render import render_dashboard_base_styles, render_confirm_modal, render_frame_script
